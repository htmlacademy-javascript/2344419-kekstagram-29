...
const renderingImg = (matchedPhoto, templateClone)=>{//функция отрисовки большого изображения
  ...
  templateClone.addEventListener('click', () =>{
    ...
    let counter = 5;//создаем счетчик

    loadingComment.addEventListener('click',()=>{//слушатель для создания 5 или меньше комментариев
  ...
  buttonX.addEventListener('click',cleanButton);
